...
```text
let selection  = HashGatedConnection::new(genesis, self_id, target_degree);              // dial side
let acceptance = VerifiableBoundedAcceptance::new(genesis, self_id, target_degree, cap_buffer); // inbound side
