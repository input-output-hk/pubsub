...
│                           #   `apply` gains one dispatch line; `subscriptions` accessor returns the effective intersection
...
│                           #   (symmetric with the 008 membership reader); `subscriptions` getter now returns the effective intersection
