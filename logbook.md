...
**Next.** Jesus: refine the identity proposal. Denis: locate and share the paper on provable misbehaviour in distributed protocols. Ezequiel and Will: run the model experiments with hash-based connection gating and resource caps enabled. Will and Ezequiel: visualisations comparing the performance metrics across all five models. Will: onboard Mauro.
