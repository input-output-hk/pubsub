...
|----|-------------|-----------|-----------|
| NFR1.1 | Message latency < 500ms for direct peer connections (P95) | DeFi and agent coordination require near-instant delivery | [DeFi Intents](../../use-cases/defi-intents.md) (architectural stress test), [Agent Coordination](../../use-cases/agent-coordination.md) |
| NFR1.2 | Support minimum 10,000 messages per second per node | Agent swarms generate high message volumes during market events | [Agent Coordination](../../use-cases/agent-coordination.md) (architectural stress test) |
| NFR1.3 | Handle 1,000+ concurrent connections per node | Relay nodes must serve many peers; SPO coordinator nodes especially | [Agent Coordination](../../use-cases/agent-coordination.md), [DeFi Intents](../../use-cases/defi-intents.md) |
...
| NFR1.5 | Protocol overhead < 10% of message payload | Mobile wallets and bandwidth-constrained users need lean protocols | [Network Operations](../../use-cases/network-operations.md), [DeFi Intents](../../use-cases/defi-intents.md) |
...
| NFR2.2 | Maintain performance with 100,000+ topics | Each DAO, NFT project, and agent type needs topic namespacing | [Network Operations](../../use-cases/network-operations.md), [Governance](../../use-cases/governance.md) |
...
| NFR2.5 | Handle traffic spikes of 10x normal load | Market crashes, viral governance proposals, NFT drops cause surges | [DeFi Intents](../../use-cases/defi-intents.md), [Agent Coordination](../../use-cases/agent-coordination.md), [Network Operations](../../use-cases/network-operations.md) |
...
| NFR3.2 | Automatic failover and recovery mechanisms | Manual intervention doesn't scale; system must self-heal | [DeFi Intents](../../use-cases/defi-intents.md) (24/7 markets), [Agent Coordination](../../use-cases/agent-coordination.md) |
| NFR3.3 | No single point of failure in the network | Decentralization promise; central points get attacked or censored | [Network Operations](../../use-cases/network-operations.md) (censorship resistance), [Governance](../../use-cases/governance.md) |
| NFR3.4 | Message persistence for 30 days minimum | Governance proposals need multi-week voting windows; offline users need catch-up | [Governance](../../use-cases/governance.md) (7-day voting), [Network Operations](../../use-cases/network-operations.md) |
...
| NFR5.3 | Example applications for common use cases | Working code beats documentation; devs learn by example | [Network Operations](../../use-cases/network-operations.md) (chat app), [DeFi Intents](../../use-cases/defi-intents.md) (intent submitter) |
...
| ID | Requirement | Rationale | Use Cases |
|----|-------------|-----------|-----------|
| NFR6.1 | Support standard cryptographic libraries | Custom crypto is risky; leverage battle-tested implementations (MLS, libp2p) | [Network Operations](../../use-cases/network-operations.md) (MLS encryption) |
...
| NFR6.3 | Bridge capability with other messaging protocols | Ecosystem play; interop with Matrix, XMPP expands reach | [Network Operations](../../use-cases/network-operations.md) |
...
| NFR6.5 | Cross-platform support (Linux, Windows, macOS, Mobile) | Users are everywhere; mobile especially critical for wallets | [Network Operations](../../use-cases/network-operations.md), [Governance](../../use-cases/governance.md) (mobile voting) |
