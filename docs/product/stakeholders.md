...
| **Senior Engineers** | *Hiring 2-3* | 🟡 Target: Q2 2025 |
...
### DeFi Protocols (Use Case Validation)

| Protocol | Use Case | Status |
|----------|----------|--------|
| Liqwid | Liquidation alerts | ⬜ To be engaged |
| Minswap | Cross-chain intents | ⬜ To be engaged |
| SundaeSwap | DeFi notifications | ⬜ To be engaged |

### Identus Team (Identity Infrastructure)

| Role | Contact | Engagement |
|------|---------|------------|
| Tech Lead | *Via Atala team* | ⬜ To be engaged Q1 2025 |
...
### Phase 1: Architecture & Prototype (2025)

| Category | Metric | Target | Measurement |
|----------|--------|--------|-------------|
| **Delivery** | Architecture approved | Q1 2025 | Sign-off |
| **Delivery** | Working prototype | Q3 2025 | Demo |
| **Team** | Tech Lead hired | Q1 2025 | Onboarded |
...
|--------|--------|-------|-------------|
| **Architecture Design Complete** | 🟡 In Progress | PM + Tech Lead | Q1 2025 |
| **Working Prototype** | ⬜ Not Started | Engineering | Q3 2025 |
| **SPO Testnet (50+ nodes)** | ⬜ Not Started | Engineering | Q1 2026 |
| **First Wallet Integration** | ⬜ Not Started | Engineering | Q2 2026 |
| **Mainnet Launch** | ⬜ Not Started | Engineering | Q2 2026 |
...
| **#pubsub-stakeholders** (Slack) | Stakeholder updates | Partners |
| **Discord server** (public) | Community, vendors, contributors | Public |
| **Weekly sync** (30 min) | Status update | Core team |
...
| API design | Tech Lead | PM | Wallet teams | All |
