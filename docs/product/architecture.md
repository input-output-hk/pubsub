...
This section identifies the primary functional drivers for the Agora architecture, derived from the use case analysis.

## Key Use Cases Overview

| Use Case | User Story | Agora's Role | Critical Architectural Drivers |
|----------|------------|--------------|-------------------------------|
...
### 1. Storage Tiers
The contrast between DeFi Intents (ephemeral) and Governance (durable) implies Agora needs a **Tiered Storage Architecture**:
...
Token-Gating and Cross-Chain use cases require the Agora Node to have a modular **"State Verification" component** that can check Cardano L1 (or Partner Chain) state to authorize actions.
