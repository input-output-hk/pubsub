...
Proposed Solutions:
    - CIP-? | Decentralised Pub/Sub Message Dissemination: ../cip/README.md
Discussions:
...
The following scenarios are drawn from the project's [use-case survey](https://github.com/input-output-hk/pubsub/blob/main/docs/actor-use-case-analysis.md). Population estimates are planning assumptions to validate with operators.
