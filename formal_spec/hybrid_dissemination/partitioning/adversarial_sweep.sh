...
# Requires: prism on PATH, ringcast_n6_adversarial.prism, adversarial.props

MODEL="ringcast_n6_adversarial.prism"
...
echo "============================================================"
echo "Adversarial partitioning sweep — RingCast H(6,2), RF=1, N=6"
