...
| [`m2_eclipse_check.py`](m2_eclipse_check.py) | Numerical verification for M2: exact vs. approximation, analytical vs. bisection k_max, M2 vs. RandCast at equal fanout, pointwise inequality check. |
